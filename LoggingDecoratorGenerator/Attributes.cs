...
internal static class Attributes
{
    ...
    private const string DecorateWithLoggerName = "DecorateWithLoggerAttribute";
    ...
    private const string LogMethodName = "LogMethodAttribute";
    ...
    private const string NotLoggedName = "NotLoggedAttribute";
